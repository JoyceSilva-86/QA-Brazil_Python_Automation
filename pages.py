...
class UrbanRoutesPage:
    ...
    comfort_icon_locator = (By.XPATH, '//img[@src="/static/media/kids.875fd8d4.svg"]')
    ...
    switch_blanket_active = (By.CSS_SELECTOR, '.r-sw > div > span')
    ...
    def click_taxi_option(self):
       self.driver.find_element(*self.taxi_option_locator)
    ...
    def click_number_text(self, telefone):
        ...
        self.driver.find_element(*self.number_finish).click()
